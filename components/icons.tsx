...
export const SparkIcon = ({ className, size = 28 }: { className?: string; size?: number }) => {
  return (
    ...
    >
      ...
      />
      <path
        d="M19.0652 11.0435C16.2022 9.40217 10.8261 9.23913 7.04348 10.2717C6.52174 10.4239 5.98913 10.1087 5.83696 9.58696C5.68478 9.06522 6 8.54348 6.52174 8.38043C10.7391 7.23913 16.7065 7.4348 20.0109 9.30435C20.4891 9.56522 20.6522 10.163 20.3913 10.6413C20.1304 11.1087 19.5326 11.2935 19.0652 11.0435ZM18.9348 14.6087C18.7174 15.0109 18.2065 15.0732 17.8043 14.7803C15.4239 13.5217 11.3913 13.087 8.18478 14.0217C7.73913 14.1413 7.27174 13.8913 7.15217 13.4457C7.03261 13 7.28261 12.5326 7.72826 12.413C11.3804 11.3587 15.8804 11.8478 18.6522 13.4783C19.0652 13.6848 19.1522 14.1957 18.9348 14.6087ZM17.5435 18.0761C17.3696 18.3913 16.9783 18.5109 16.663 18.337C14.663 17.1196 11.8152 16.7717 8.43478 17.5326C8.08696 17.6196 7.73913 17.4022 7.65217 17.0543C7.56522 16.7065 7.78261 16.3587 8.13043 16.2717C11.8587 15.4348 15.0543 15.8261 17.337 17.2065C17.6522 17.3804 17.7174 17.7609 17.5435 18.0761Z"
        fill="#0A0A0A"
      />
    </svg>
  );
...
export const SpotifyIcon = ({ size = 16 }: { size?: number }) => {
  return (
    <svg
      ...
      style={{ color: 'currentcolor' }}
    >
      <path d="M8 0C3.589 0 0 3.589 0 8s3.589 8 8 8 8-3.589 8-8-3.589-8-8-8zm3.67 11.548a.499.499 0 0 1-.696.122c-1.875-1.318-4.994-1.391-6.087-1.078a.499.499 0 0 1-.222-.975c1.326-.366 4.89-.315 7.128 1.234a.499.499 0 0 1 .122.697h-.002zm.976-2.432a.624.624 0 0 1-.87.153c-2.091-1.459-5.544-1.523-6.936-1.174a.624.624 0 1 1-.244-1.225c1.646-.414 5.811-.326 8.197 1.375a.624.624 0 0 1 .153.871zm.085-2.327c-2.384-1.66-6.785-1.765-8.477-1.223a.748.748 0 0 1-.925-.493.75.75 0 0 1 .493-.925c1.99-.59 6.76-.476 9.518 1.419a.75.75 0 0 1-.609 1.37V6.79z"/>
    </svg>
  );
};
