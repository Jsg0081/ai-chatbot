      ...
      >
        ...
        >
          {message.role === 'assistant' && (
            <div className="size-6 sm:size-8 flex items-center rounded-full justify-center ring-1 shrink-0 ring-border bg-background">
          ...
          <div
            className={cn('flex flex-col gap-2 sm:gap-4 w-full', {
...
export const ThinkingMessage = () => {
  ...
  return (
    <motion.div
      ...
      className="w-full mx-auto max-w-3xl px-2 sm:px-4 group/message min-h-96"
      initial={{ y: 5, opacity: 0 }}
    ...
    >
      <div
        className={cx(
          'flex gap-2 sm:gap-4 group-data-[role=user]/message:px-3 w-full group-data-[role=user]/message:w-fit group-data-[role=user]/message:ml-auto group-data-[role=user]/message:max-w-2xl group-data-[role=user]/message:py-2 rounded-xl',
          {
            'group-data-[role=user]/message:bg-muted': true,
          },
        )}
      >
        <div className="size-6 sm:size-8 flex items-center rounded-full justify-center ring-1 shrink-0 ring-border">
          <SparklesIcon size={14} />
        </div>

        <div className="flex flex-col gap-2 w-full">
          <div className="flex flex-col gap-2 sm:gap-4 text-muted-foreground text-sm sm:text-base">
            Hmm...
          </div>
        </div>
      </div>
